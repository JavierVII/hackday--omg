...
export function BeadsGame({ onClose, onComplete }: BeadsGameProps) {
  ...
  const finish = () => {
    ...
    onComplete?.({ completed: true, filledCount: filled, artworkData: board, rewardUnlocked: true })
