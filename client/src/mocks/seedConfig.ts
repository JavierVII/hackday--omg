...
export const seedConfig: ScenicExperienceConfig = {
  ...
  interactionPoints: [
    ...
    },
    {
      ...
      miniGameId: WEST_LAKE_IDS.miniGames.touhu,
      enabled: true,
    },
    {
      id: "interaction-wuguitan-beads",
      sceneId: WEST_LAKE_IDS.scenes.reserved,
      type: "game",
      name: "西湖串珠",
      position: { x: -1.2, y: -2.4, z: 39.2 },
      miniGameId: WEST_LAKE_IDS.miniGames.beads,
      enabled: true,
    },
  ],
  miniGames: [
    ...
    {
      id: WEST_LAKE_IDS.miniGames.touhu,
      type: "touhu",
      title: "雅趣投壶",
      content: {
    ...
    {
      id: WEST_LAKE_IDS.miniGames.beads,
      type: "beads",
      title: "西湖串珠",
      content: {
        question: "串起西湖记忆，完成一串专属手作。",
        hint: "按颜色与纹样完成串珠排列。",
        options: [],
        answerIndex: -1,
      },
